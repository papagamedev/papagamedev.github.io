...
{% include image url="futbol_tv.jpg" caption="En nuestra televisión super moderna, disfrutamos viendo los partidos de Chile (la imagen es del Mundial del 62)" %}
...
{% include image url="futbol_oldgame.jpg" caption="Pele’s Championship Soccer (1980, Atari 2600), la definición de un juego de fútbol «primitivo»" %}
...
{% include image url="futbol_nintendoworldcup.jpg" caption="En **Nintendo Worldcup** (1990, NES), era usual que los partidos terminaran con jugadores desplomados en el piso, ya sea por haber recibido pelotazos o directamente patadas de sus oponentes." %}
...
{% include image url="futbol_pocketleaguestory.jpg" caption="En Pocket League Story (2011, iOS/Android), uno administra al equipo de fútbol, decide qué entrenamientos hacer, cómo jugar los partidos y en qué torneos jugar." %}
...
{% include image url="futbol_supersoccer.jpg" caption="En Super Soccer (1991, SNES), se podía ver la cancha completa hacia adelante, lo que se podía aprovechar para darle mayor profundidad estratégica al juego." %}
...
{% include image url="tehkan_win.png" caption="Llegar a la final de Tehkan Worldcup requería de aprender las «mañas» del juego y de mucha práctica. Por eso, ganarla era un momento realmente glorioso." %}
...
{% include image url="futbol_fifa16.jpg" caption="Juegos como FIFA y PES permiten jugar de hasta siete jugadores simultáneamente en la misma consola, ya sea como rivales o compañeros. La experiencia social es notable." %}
...
{% include image url="tehkan_gameplay.png" caption="En Tehkan Worldcup (1985, Arcade), la cancha y los jugadores se ven desde arriba. El juego es muy rápido y se veía bastante bien para la época en que se publicó." %}
