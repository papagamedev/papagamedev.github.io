...
translation_url: /2015/12/dad-check-levels-made.html
---
...
{% include image url="geometrydash-darkangel.jpg" caption="Un nivel difícil en Geometry Dash, donde el jugador casi debe hacer magia para que la nave pase a toda velocidad por ese estrecho pasadizo lleno de pinchos." %}
...
{% include image url="geometrydash-levelselection.jpg" caption="Los creadores que hacen los niveles Top en Geometry Dash son verdaderos gurús para el resto de los jugadores" %}
...
{% include image url="geometrydash-editor2.jpg" caption="La edición de niveles en Geomery Dash: cada obstáculo y elemento del juego se coloca cuidadosamente para definir el recorrido del jugador." %}
...
{% include image url="leveldesign-portal.jpg" caption="Diseño de uno de los niveles de Portal, uno de los juegos más influyentes de la última década." %}
...
{% include image url="leveldesign-montezuma.jpg" caption="En Montezuma y Montezuma’s Revenge el diseño de niveles es muy cuidadoso en introducirle al jugador los tipos de enemigos y puzzles paulatinamente." %}
...
{% include image url="leveldesign-peanuts.jpg" caption="En Peanuts, el último proyecto de Behaviour Chile, los diseñadores de niveles han construido una gran variedad de etapas, llenas de puzzles y objetos por encontrar." %}
...
Hay sitios web que se dedican a publicar artículos y tutoriales completamente orientados a la disciplina del diseño de niveles. Uno de los más populares es [World of Level Design](http://www.worldofleveldesign.com/) (en inglés), pero también hay otros en español que, aunque tienen menos contenido, también tienen lecciones interesantes.
...
{% include image url="boulderdash-screenshot.jpg" caption="En Boulder Dash, el personaje debe tomar los cristales evitando ser aplastado por las piedras." %}
...
{% include image url="boulderdash-screenshot2.png" caption="En Boulder Dash también hay enemigos, cuadrados y mariposas." %}
...
{% include image url="boulderdash-construction.jpg" caption="Boulder Dash Construction Kit, donde el jugador podía crear sus propios niveles." %}
