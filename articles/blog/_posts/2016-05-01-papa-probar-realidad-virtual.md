...
Estábamos en [Festigame](http://www.festigame.cl/), en el único stand donde se podía probar el dispositivo, y que correspondía a una marca de snacks que estaba promocionando sus productos a través de una experiencia de realidad virtual. Habían instalado un asiento con forma de carrito de **montaña rusa** y la experiencia trataba, justamente, de un paseo a alta velocidad por una montaña rusa llena de curvas, subidas y bajadas.

{% include image url="oculus_festigame.jpg" caption="Mi hijo Diego probando el Oculus en Festigame 2014: un recorrido en una montaña rusa virtual." %}
...
{% include image url="tron_afiche.jpg" caption="Tron (1982), una de las películas que ha explorado la idea de la Realidad Virtual." %}
...
{% include image url="vr-medicine.jpg" caption="Las aplicaciones de la Realidad Virtual en medicina son numerosas y van desde el tratamiento de fobias hasta el entrenamiento de procedimientos complicados." %}
...
[World of Comenius](https://frooxius.itch.io/world-of-comenius), por ejemplo, es una aplicación que integra un sistema para enseñar materias tan interesantes como anatomía o biología celular. A través de experiencias en las que los niños pueden ver e interactuar con maquetas del cuerpo humano, se puede usar en colegios para que los alumnos se diviertan y, a la vez, aprendan.

{% include image url="world-comenius.jpg" caption="World of Comenius, una aplicación educacional que aprovecha el potencial de la Realidad Virtual" %}
...
{% include image url="virtual-boy.jpg" caption="Virtual Boy, la consola portátil de «Realidad Virtual» que Nintendo lanzó en 1995" %}
...
{% include image url="forte-vfx1.jpg" caption="El Forte VFX1, lanzado en 1996, fue un HMD que ofrecía una experiencia de Realidad Virtual bastante decente para la época." %}
...
{% include image url="oculus-rift.jpg" caption="Después de dos versiones de desarrollo, el Oculus Rift fue lanzado en Marzo de este año al mercado." %}
...
{% include image url="google-cardboard.jpg" caption="El Google Cardboard, la alternativa más económica." %}
...
Son todas preguntas válidas y no todas tienen respuestas obvias, por lo que abordaré estos temas en el [siguiente artículo]({% post_url /articles/blog/2016-05-09-papa-quiero-lentes-magicos %}) de Papá Game Dev. ¡Hasta entonces!
