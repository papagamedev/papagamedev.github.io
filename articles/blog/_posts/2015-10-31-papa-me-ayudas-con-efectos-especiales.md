...
{% include image url="juegos_del_hambre.png" caption="Diego necesitaba efectos especiales como los de esta imagen, nada más." %}
...
{% include image url="pelicula_vaqueros.jpg" caption="Si no existieran los efectos especiales, el actor habría muerto al filmar esta escena." %}
...
{% include image url="matrix-fx.jpg" caption="En la popular saga de películas Matrix, la tecnología usada para filmar algunas escenas es impresionante. En esta, por ejemplo, se usaron decenas de cámaras de alta velocidad para poder generar el efecto de que la cámara gira mientras los protagonistas parecen moverse en cámara lenta." %}
...
{% include image url="superman.jpg" caption="Clásica escena de Superman, donde el protagonista emprende el vuelo." %}
...
{% include image url="mujer_playa_viento.jpg" caption="Bella actriz + playa + atardecer + viento = escena perfecta de una película, casi imposible de reproducir en un videojuego." %}
...
{% include image url="forza_motorsport_6.jpg" caption="Asombroso, no hay otra forma de describir la fidelidad visual de algunos videojuegos de la última generación como Forza Motorsport 6" %}
...
{% include image url="nuevas_consolas.jpg" caption="La nueva generación de consolas, especialmente la Xbox One y la Playstation 4, trajeron a los jugadores un gran incremento en la calidad visual de los videojuegos con respecto a la generación anterior" %}
...
{% include image url="ps3_vs_ps4.jpg" caption="Esta escena, de GTA5, muestra la clara diferencia entre dos generaciones de consolas. El poder de procesamiento de la PS4 le permite simular el mar con mucho más realismo y calidad visual." %}

En Behaviour, la empresa donde trabajo, hemos tenido que lidiar con este desafío muchas veces. El último caso es bastante reciente, y se trata del videojuego llamado **«Peanuts: Snoopy’s Grand Adventure»**. En este juego ([ver video promocional](https://www.youtube.com/watch?v=riJ2xvqRo94)) el equipo tuvo que trabajar muy duro para que el contenido funcionara en cinco consolas: la 3DS, la Wii U, la Xbox 360, la Xbox One y la PlayStation 4.

{% include image url="peanuts_afiche.jpg" caption="Peanuts: Snoopy’s Grand Adventure" %}
