...
{{< image url="pokemongo_jp.jpg" caption="My just created Pokémon GO profile" >}}
...
{{< image url="pokemongo_pikachu.jpg" caption="In the Pokémon video trailer, the Pokémon are 100% immersed in the real world. Pikachu even leaves a shadow on the ground and its tail is shaded by the wall on the left." >}}
...
{{< image url="pokemon_pikachu_ar.jpg" caption="In practice, the Pokémon in Pokémon GO are simply an overlay on top of the camera image. There is a small and diffuse shadow beneath them that sometimes seems to really be on a surface." >}}
