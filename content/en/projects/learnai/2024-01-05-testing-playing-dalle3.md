...
{{< image url="learnai/dalle3.jpg" caption="DALL-E 3, as depicted by DALL-E 3 itself" >}}

Last week, while searching for images for the [article about my son’s Python game]({{< relref "articles/blog/2023-12-30-dad-made-game-python.md" >}}), I thought I might generate them using *DALL-E 3* and thus take the opportunity to test it out.
...
{{< image url="learnai/dalle3-cat-coding-python-vivid.jpg" caption="Image generated with DALL-E 3 of a cat coding in Python" >}}
...
{{< image url="learnai/dalle3-cat-coding-python-natural.jpg" caption="Image generated with DALL-E 3, now with a natural style" >}}
...
{{< image url="learnai/dalle3-fish-playing-soccer.jpg" caption="A fish playing soccer (standard, vivid)" >}}
...
{{< image url="learnai/dalle3-cat-playing-soccer.jpg" caption="A cat playing soccer (standard, vivid)" >}}

{{< image url="learnai/dalle3-fish-eating-sushi-natural.jpg" caption="A fish eating sushi (standard, natural)" >}}

{{< image url="learnai/dalle3-fish-eating-sushi-vivid.jpg" caption="A fish eating sushi (standard, vivid)" >}}

{{< image url="learnai/dalle3-cat-in-cat-house.jpg" caption="A cat in a cat house (standard, vivid)" >}}

{{< image url="learnai/dalle3-cat-vaporeon-costume.jpg" caption="A cat dressed up as the Pokémon Vaporeon (standard, natural)" >}}
...
{{< image url="learnai/dalle3-cat-playing-soccer-hd.jpg" caption="A cat playing soccer (hd, vivid)" >}}

{{< image url="learnai/dalle3-cat-vaporeon-costume-hd.jpg" caption="A cat dressed up as Vaporeon (hd, natural)" >}}
...
{{< image url="learnai/dalle3-fish-eating-cat-complex-prompt.jpg" caption="A longer text, resulting in a not so good outcome" >}}

{{< image url="learnai/dalle3-fish-eating-cat-simple-prompt.jpg" caption="A simpler text, with a better outcome" >}}
